...
array( "name" => $themename." ",
   ...
   /* array( "name" => "Latest Posts From Categories",
    ...
    array(  "name" => "Mostrar/Ocultar Latest Posts",
 	...
 	array(	"name" => "Choose Which <strong>Category</strong> To Feature?",
			"id" => $shortname."_featured_category1",
            "type" => "select",
            "std" => "Select A Category",
			"options" => $mx_categories),

			array(	"name" => "Choose How Many <strong>Post</strong> To Display?",
			"id" => $shortname."_featured_number1pet",
            "type" => "select",
            "std" => "Select A Number",
			"options" => $number_entries),
